...
{
	CPPUNIT_ASSERT(noeud->obtenirType() == ArbreRenduINF2990::NOM_ACCELERATEUR);
...
void NoeudAbstraitTest::testEnfants()
{
	...
	NoeudAbstrait* nouveauNoeud{ new NoeudAccelerateur{ ArbreRenduINF2990::NOM_ACCELERATEUR } };
