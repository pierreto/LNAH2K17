...
///
////////////////////////////////////////////////////////////////////////
ModeleEtatJeuOnline::ModeleEtatJeuOnline()
	: ModeleEtat() {
	speedMailletZ_ = 0;
	speedMailletX_ = 0;
...
ModeleEtatJeuOnline* ModeleEtatJeuOnline::instance_{ nullptr };


////////////////////////////////////////////////////////////////////////
///
/// @fn ModeleEtatJeuOnline* ModeleEtatJeuOnline::obtenirInstance()
///
...
///
////////////////////////////////////////////////////////////////////////
ModeleEtatJeuOnline* ModeleEtatJeuOnline::obtenirInstance() {
	if (instance_ == nullptr)
		instance_ = new ModeleEtatJeuOnline();
...
////////////////////////////////////////////////////////////////////////
///
/// @fn void ModeleEtatJeuOnline::libererInstance()
///
...
///
////////////////////////////////////////////////////////////////////////
void ModeleEtatJeuOnline::libererInstance() {
	delete instance_;
	instance_ = nullptr;
}
...
void ModeleEtatJeuOnline::mouseMoveOpponent(int x, int y)
{
	//TODO: IMPLEMENT
}
...
////////////////////////////////////////////////////////////////////////
///
/// @fn ModeleEtatJeuOnline::tryNewPosition(NoeudMaillet* maillet, glm::vec3 position, std::vector<utilitaire::Segment2D>& segments)
///
...
///
////////////////////////////////////////////////////////////////////////
void ModeleEtatJeuOnline::tryNewPosition(NoeudMaillet* maillet, glm::vec3 position, std::vector<utilitaire::Segment2D>& segments) {
...
////////////////////////////////////////////////////////////////////////
///
/// @fn void ModeleEtatJeuOnline::escape() 
///
...
///
////////////////////////////////////////////////////////////////////////
void ModeleEtatJeuOnline::escape() {
...
////////////////////////////////////////////////////////////////////////
///
/// @fn void ModeleEtatJeuOnlineOnline::calculateSegments() 
///
...
///
////////////////////////////////////////////////////////////////////////
void ModeleEtatJeuOnline::calculateSegments() {
...
////////////////////////////////////////////////////////////////////////
///
/// @fn void ModeleEtatJeuOnlineOnline:moveMailletAdversaire() 
///
...
///
////////////////////////////////////////////////////////////////////////
void ModeleEtatJeuOnline::moveMaillet() {
	if (!gamePaused_ && gameStarted_ && !gameEnded_) {
...
////////////////////////////////////////////////////////////////////////
///
/// @fn bool ModeleEtatJeuOnlineOnline::isGameOver(const int& neededGoals)
///
...
///
////////////////////////////////////////////////////////////////////////
bool ModeleEtatJeuOnline::isGameOver(const int& neededGoals) {
...
////////////////////////////////////////////////////////////////////////
///
/// @fn ModeleEtatJeuOnlineOnline::getGameScore(float score[]) const
///
...
///
////////////////////////////////////////////////////////////////////////
void ModeleEtatJeuOnline::getGameScore(int score[]) const {
...
///
////////////////////////////////////////////////////////////////////////
void ModeleEtatJeuOnline::resetGame() {
	gamePaused_ = false;
	gameEnded_ = false;
...
////////////////////////////////////////////////////////////////////////
///
/// @fn void ModeleEtatJeuOnline::aiActiveProfile(int speed, int passivity)
///
...
///
////////////////////////////////////////////////////////////////////////
void ModeleEtatJeuOnline::aiActiveProfile(int speed, int passivity) {
	aiSpeed_ = speed;
...
////////////////////////////////////////////////////////////////////////
///
/// @fn void ModeleEtatJeuOnline::miseAuJeu()
///
...
///
////////////////////////////////////////////////////////////////////////
void ModeleEtatJeuOnline::miseAuJeu() {
...
////////////////////////////////////////////////////////////////////////
///
/// @fn void ModeleEtatJeuOnline::afficher()
///
...
///
////////////////////////////////////////////////////////////////////////
void ModeleEtatJeuOnline::afficher() {
	GLint Cloture[4];
...
////////////////////////////////////////////////////////////////////////
///
/// @fn void ModeleEtatJeuOnline::setPlayerNames(std::string player1, std::string player2)
///
...
///
////////////////////////////////////////////////////////////////////////
void ModeleEtatJeuOnline::setPlayerNames(std::string player1, std::string player2) {
...
////////////////////////////////////////////////////////////////////////
///
/// @fn void ModeleEtatJeuOnline::setPlayerColors(glm::vec3 player1, glm::vec3 player2)
///
...
///
////////////////////////////////////////////////////////////////////////
void ModeleEtatJeuOnline::setPlayerColors(glm::vec4 player1, glm::vec4 player2) {
