...
namespace modele{
	...
	public:
		...
		/// Méthode pour modifier les vertex du mesh	
		inline void				   modifierSommets(Conteneur<Vertex>& sommets);
	...
	////////////////////////////////////////////////////////////////////////
	///
	/// @fn inline void	Mesh::modifierSommets(Conteneur<Vertex>& sommets)
	///
	/// Cette fonction modifie les sommets dont est composé le mesh.
	///
	/// @return les sommets (const).
	///
	////////////////////////////////////////////////////////////////////////
	inline void	Mesh::modifierSommets(Conteneur<Vertex>& sommets)
	{
		vertices_ = sommets;
	}
