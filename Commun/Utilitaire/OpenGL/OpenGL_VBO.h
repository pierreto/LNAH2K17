...
namespace opengl{
	...
	public:
		...
		virtual void dessiner(const glm::mat4& transformation, const OptionsDessin& options = OptionsDessin(), MatricesPipeline& matrices = MatricesPipeline()) const;
	...
	private:
		...
		/// Dessin récursifw	
		void dessiner(modele::Noeud const& noeud, unsigned int& bufferIndex, const glm::mat4& transformation, const OptionsDessin& options = OptionsDessin(), MatricesPipeline& matrices = MatricesPipeline()) const;
